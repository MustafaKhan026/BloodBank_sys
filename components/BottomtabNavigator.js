...
export default function BottomTabNavigator({navigation, routeName}) {
  ...
  return (
    <View style={[styles.container,{display:ScreenName =="Entry" ? 'none' :'flex'}]}>
      <View style={styles.wrapper}>
        ...
        <View style={styles.iconContainer}>
            <TouchableOpacity style={styles.iconContainerInner} onPress={()=>navigation.navigate("AboutUs")}>
                {ScreenName == "AboutUs" ? (
        ...
        <View style={styles.iconContainer}>
            <TouchableOpacity style={styles.iconContainerInner} onPress={()=>navigation.navigate("Settings")}>
                {ScreenName == "Settings" ? (
                    <Image source={require("../assets/icons/setting-active.png")} style={{width:30,height:30}}/>
                ) :(
                    <Image source={require("../assets/icons/setting.png")} style={{width:30,height:30}}/>
                )}
